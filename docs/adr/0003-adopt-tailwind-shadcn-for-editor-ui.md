...
- `packages/editor` currently exports `./styles.css`, and `apps/web` imports
  `@html-slides-editor/editor/styles.css`.
...
- Preserve `@html-slides-editor/editor/styles.css` as the CSS import path unless
...
- [ ] `apps/web` can render the editor by importing
      `@html-slides-editor/editor` and `@html-slides-editor/editor/styles.css`.
